...
//
//
////        setup_toolbar = view.findViewById(R.id.setup_tolbar);
...
//        setupimage =view.findViewById(R.id.setupimage);
...
//
//                        Glide.with(getActivity()).setDefaultRequestOptions(placeholderrequestOption).load(image).into(setupimage);
//
...
//                    Toast.makeText(getActivity(),"Firestore Retrieving Error"+retrievError,Toast.LENGTH_LONG).show();
//                }
//
...
//
//                                    Toast.makeText(getActivity(), "Image Error :" + errormsg, Toast.LENGTH_LONG).show();
//
//                                    progressDialog.dismiss();
//                                }
//
...
////            @Override
////            public void onClick(View view) {
////                Intent main = new Intent(getActivity(),Home_Frament.class);
////                startActivity(main);
////
////            }
////        });
...
////                        Intent demo = new Intent(getActivity(),Home_Frament.class);
////                        startActivity(demo);
////                        // Update your UI here.
////                    }
////                });
...
//                if (task.isSuccessful()){
//
//                    Toast.makeText(getActivity(),"The user Setting are Update" ,Toast.LENGTH_LONG).show();
//
...
//                    String errormsg = task.getException().getMessage();
//
//                    Toast.makeText(getActivity(),"Frestore Error :" + errormsg,Toast.LENGTH_LONG).show();
//
//
//                }
//                progressDialog.dismiss();
